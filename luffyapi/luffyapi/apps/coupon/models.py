...
class Coupon(BaseModel):
    ...
    coupon_type=models.SmallIntegerField(choices=coupon_choice,default=1,verbose_name='优惠券类型')
    timer=models.IntegerField(verbose_name='优惠券有效期',default=30,help_text='单位:天')
    condition=models.IntegerField(blank=True,default=0,verbose_name='满足优惠券的价格条件')
