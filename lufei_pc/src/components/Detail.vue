      ...
      <div class="main">
        <div class="course-info">
          ...
          <videoPlayer v-if="course.course_video" class="video-player vjs-custom-skin"
            ...
            <img v-if="!course.course_video" :src="course.course_image" alt="">
          </div>
              ...
              <div class="chapter-item" v-for="chapter,key in course.chapter_list" :key="key">
                ...
                <ul class="lesson-list">
                  <li class="lesson-item" v-for="lesson,key in chapter.lesson_list" :key="key">
                    <p class="name"><span class="index">1-{{key+1}}</span> {{lesson.name}}<span class="free" v-if="lesson.free_trail">免费</span></p>
                    ...
                    <button class="try" v-if="lesson.free_trail && lesson.section_type==1"><router-link :to="`/course/lesson/exam/${lesson.id}`">立即试学</router-link></button>
                    <button class="try" v-if="lesson.free_trail && lesson.section_type==0"><router-link :to="`/course/lesson/doc/${lesson.id}`">立即试学</router-link></button>
               ...
               <div class="teacher-content">
                 <div class="cont1">
                   ...
                   <div class="name">
                     ...
                     <p class="teacher-title">{{course.teacher.role}}</p>
                   </div>
                 </div>
...
export default {
    ...
    methods: {
      ...
      get_course(){
          this.$axios.get(`${this.$settings.Host}/courses/course/${this.course_id}/`).then(response=>{
